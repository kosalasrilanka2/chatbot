...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('conversations', function (Blueprint $table) {
            ...
            $table->string('priority')->default('normal')->after('preferred_domain'); // normal, high, urgent
            $table->json('skill_requirements')->nullable()->after('priority'); // Store specific skill requirements
